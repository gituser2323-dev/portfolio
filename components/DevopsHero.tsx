    ...
    >
      ...
      <div className="relative z-10 text-center max-w-6xl w-full">
        ...
        <motion.div
          ...
          "
        >
          Cloud & DevOps Course in FC Road Pune
        </motion.div>
        ...
        <motion.p
          ...
          "
        >
          Industry-focused Cloud and DevOps training in Shivaji Nagar Pune using
          AWS, Docker, Kubernetes, Linux and CI/CD pipelines to build
          scalable deployment and infrastructure automation systems.
        </motion.p>
        ...
        >
          <div className="flex flex-col items-center">
            <span className="text-orange-400 text-base md:text-lg">A</span>
            <span>AWS</span>
          </div>
          ...
          <div className="flex flex-col items-center">
            <span className="text-cyan-400 text-base md:text-lg">K</span>
            <span>KUBERNETES</span>
          </div>

          <div className="flex flex-col items-center">
            <span className="text-white text-base md:text-lg">C</span>
            <span>CI/CD</span>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <span className="relative z-10 group-hover:text-white transition">
              Enroll in DevOps Program →
            </span>
          </Link>

          <Link
            href="/DevOps_Syllabus.pdf"
            target="_blank"
            className="
              w-full sm:w-auto
              px-8 md:px-14

...
export default function DataAnalystHero() {
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-6xl w-full">
        ...
        <motion.p
          ...
          "
        >
          Industry-focused Data Analyst training in Pune using
          Excel, SQL, Power BI and Python to build dashboards,
          reports and real-world business analytics solutions.
        </motion.p>
        ...
        >
          <div className="flex flex-col items-center">
            <span className="text-green-400 text-base md:text-lg">E</span>
            <span>EXCEL</span>
          </div>

          <div className="flex flex-col items-center">
            <span className="text-blue-400 text-base md:text-lg">S</span>
            <span>SQL</span>
          </div>
          ...
          <div className="flex flex-col items-center">
            <span className="text-cyan-400 text-base md:text-lg">P</span>
            <span>PYTHON</span>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <span className="relative z-10 group-hover:text-white transition">
              Enroll in Data Analyst Program →
            </span>
          </Link>

          <Link
            href="/Data_Analyst_Syllabus.pdf"
            target="_blank"
            className="
              w-full sm:w-auto
              px-8 md:px-14

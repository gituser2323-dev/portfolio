  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-black text-white overflow-hidden px-6 pt-28 md:pt-0">
      ...
      <div className="relative z-10 text-center max-w-6xl w-full">
        ...
        >
          Industry-focused Java Full Stack training in Pune designed to build scalable
          applications using Java, Spring Boot, React.js and modern backend systems.
          <br className="hidden md:block" />
          Learn APIs, deployment, architecture and real-world software development.
        </motion.p>
        ...
        >
          <div className="flex flex-col items-center">
            <span className="text-orange-500 text-base md:text-lg">J</span>
            <span>JAVA</span>
          </div>

          <div className="flex flex-col items-center">
            <span className="text-green-400 text-base md:text-lg">S</span>
            <span>SPRING</span>
          </div>
          ...
          <div className="flex flex-col items-center">
            <span className="text-yellow-400 text-base md:text-lg">M</span>
            <span>MYSQL</span>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <span className="relative z-10 group-hover:text-white transition">
              Enroll in Java Program →
            </span>
          </Link>

          <Link
            href="/Java_Full_Stack_Curriculum.pdf"
            target="_blank"

    ...
    >
      ...
      <div className="relative z-10 text-center max-w-6xl w-full">
        ...
        <motion.p
          ...
          "
        >
          Industry-focused Python Full Stack training in FC Road Pune using
          Python, Django, REST APIs and React.js to build scalable
          real-world web applications and backend systems.
        </motion.p>
        ...
        >
          ...
          <div className="flex flex-col items-center">
            <span className="text-green-500 text-base md:text-lg">D</span>
            <span>DJANGO</span>
          </div>
          ...
          <div className="flex flex-col items-center">
            <span className="text-cyan-400 text-base md:text-lg">S</span>
            <span>SYSTEMS</span>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <span className="relative z-10 group-hover:text-white transition">
              Enroll in Python Program →
            </span>
          </Link>

          <Link
            href="/Python_Syllabus.pdf"
            target="_blank"
            className="
              w-full sm:w-auto
              px-8 md:px-14
